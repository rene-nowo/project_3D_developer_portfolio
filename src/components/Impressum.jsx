    ...
    <div style={impressumStyle}>
      <div className='impressum'>
        ...
        <p>
          ...
          Telefon: +49-015789095276<br />
          E-Mail: <a href='mailto:r.nowotny@denqfabrik.de'>r.nowotny@denqfabrik.de</a><br />
        </p>
        <p>
        ...
        <p>Weitere Informationen finden Sie auf https://denqfabrik.de/datenschutz</p>
        </p>
        <br />
      </div>
    </div>
